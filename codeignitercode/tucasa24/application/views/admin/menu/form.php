...
if (isset($result)) {
    ...
    $path = admin_url('menu/update');
} else {
  $id = '';
  $parent_id = '';
    $path = admin_url('menu/save');
}
?>
  ...
  ?>
                          ...
                          <div class="row">
                           ...
                           <div class="col-md-6 hide_me_feature">
                               <a href="<?php echo site_url('uploads/images/full/'.$result['image']); ?>" class="lightbox">
                                    <img src="<?php echo site_url('uploads/images/full/'.$result['image']); ?>" alt="Image" class="img-media admin-logo-img">
                                </a> 
                    ...
                    <div class="form-actions text-left "> 
                      ...
                      <input type="submit" value="<?php if(isset($result)){ echo "update"; }else{ echo "save"; } ?>" class="btn btn-primary"> 
                       <a href="<?php echo admin_url('menu'); ?>" class="btn btn-danger">Cancel</a> 
