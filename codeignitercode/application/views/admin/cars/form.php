...
<!-- Page content --> 
            ...
            <div class="breadcrumb-holder">
                <div class="container-fluid">
                  <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php if(isset($car->add_edit) && $car->add_edit == "edit"){ echo "Edit Vehicle"; }else{  echo "Add Vehicle"; }  ?></li>
                  </ul>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="page-title"> 
                    <h1 class="h3 display"><?php if(isset($car->add_edit) && $car->add_edit == "edit"){ echo "Edit Vehicle"; }else{  echo "Add Vehicle"; }  ?></h1>
                </div>
       ...
       <form action="<?= $path; ?>" method="post" enctype="multipart/form-data" role="form"> 
           <div class="card card-default"> 
            ...
            <label>Vehicle View</label>
                  ...
                  <g id="XMLID_2_">
                      <ellipse id="XMLID_10_" cx="1139.6" cy="196.8" rx="74.7" ry="78.5" fill="#333"/>
                      <ellipse id="XMLID_4_"  cx="666.6" cy="196.8" rx="74.7" ry="78.5" fill="#333"/>
                      <path id="XMLID_23_" d="M1222.8,24.6c-15.1-3.2-54.7-10.2-70.4-14c-46.9-11.5-88.9-39.9-131.1-63.1
                          ...
                          c-0.6-0.6-0.1-1.7,0.6-1.5c69.1,14.5,164.3,73.9,180.7,84.4c0.7,0.4,0.3,1.5-0.5,1.5l-93.1-2.7C974.2-3.3,973-3.9,971.5-4.5z" fill="#333"/>
                  </g>
              </svg>
                                                 
              <svg   version="1.1"  id="Shape_1_8_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="156 -55.5 491.5 261.5" style="enable-background:new 146 -145.5 491.5 491.5;" xml:space="preserve">
                  <style type="text/css">
                      .st0{fill:none;}
                  </style>
                  <g id="Layer_x0020_1">
                      <path d="M218.8-12.6H454c3.1,0,5.6,2.5,5.6,5.6v173.8c0,3.1-2.5,5.6-5.6,5.6H333.2c-0.2-9.9-4.3-19.4-11.3-26.4
                          ...
                          c1.5,0,2.8-1.3,2.8-2.8c0-1.5-1.3-2.8-2.8-2.8H261.4z" fill="#333"/>
                      <path d="M317.9,149.9c-6-6-14.2-9.7-23.4-9.7c-9.1,0-17.4,3.7-23.4,9.7c-6,6-9.7,14.2-9.7,23.4c0,9.1,3.7,17.4,9.7,23.4
                          c6,6,14.2,9.7,23.4,9.7c9.1,0,17.4-3.7,23.4-9.7c6-6,9.7-14.2,9.7-23.4C327.6,164.2,323.9,155.9,317.9,149.9L317.9,149.9z
                           M303,173.3c0,4.7-3.8,8.5-8.5,8.5c-4.7,0-8.5-3.8-8.5-8.5c0-4.7,3.8-8.5,8.5-8.5C299.2,164.8,303,168.6,303,173.3z" fill="#333"/>
                      <path d="M487.7,173.3c0,9.1,3.7,17.4,9.7,23.4c6,6,14.2,9.7,23.4,9.7c9.1,0,17.4-3.7,23.4-9.7c6-6,9.7-14.2,9.7-23.4
                          ...
                          c0,4.7-3.8,8.5-8.5,8.5c-4.7,0-8.5-3.8-8.5-8.5c0-4.7,3.8-8.5,8.5-8.5C525.4,164.8,529.2,168.6,529.2,173.3z" fill="#333"/>
                      <path d="M520.7,134.7c10.3,0,20.1,4.1,27.3,11.3c7.1,7.1,11.1,16.5,11.3,26.4h16.9c3.1,0,5.6-2.5,5.6-5.6V83.7
                          ...
                          C541.7,58.6,549.6,67.1,549.6,77.5L549.6,77.5z" fill="#333"/>
                  </g>
                  <rect x="146" y="-145.5" class="st0" width="491.5" height="491.5"/>
              </svg>

              <svg  version="1.1" id="Shape_1_5_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"   viewBox="30 61.2 160 69.8" style="enable-background:new 0 51.2 200 99.8;width:80px !important;" xml:space="preserve">
                  <g id="XMLID_14_">
                      <path d="M174.1,102.5c-1.5-2.2-3.6-3.5-6.1-4.2c-2.6-0.8-5.6-0.9-8.2-1c-2.7-0.1-5.3-0.3-8-0.5c-3.7-0.3-7.6,0.1-11.2-0.8
                          ...
                          c25.1,0.2,34,8.7,34,8.7H63.2z" fill="#333"/>
                      <circle id="XMLID_17_" cx="62.9" cy="116.7" r="9.7" fill="#333"/>
                      <circle id="XMLID_15_" cx="147.7" cy="116.7" r="9.7" fill="#333"/>
                  </g>
                  <g>
                      <line x1="74.5" y1="115.6" x2="135.6" y2="116.8" fill="#333"/>
                      <path  d="M74.5,115.5c0,0,3.8,0,9.6-0.1c5.7-0.1,13.4,0,21,0c3.8,0,7.6-0.1,11.2,0c1.8,0.1,3.5,0.1,5.2,0.2
                          ...
                          c-3.6-0.1-7.4-0.3-11.2-0.5c-7.6-0.3-15.3-0.6-21-0.9c-5.7-0.3-9.5-0.4-9.5-0.4L74.5,115.5z" fill="#333"/>
                  </g>
              </svg>
                  ...
                  <g id="Shape_1">
                      <g>
                          <path  d="M625.8,240.9c5.5,3.9,11.9,6.6,18.9,7.8V225c-0.7-0.3-1.4-0.5-2.1-0.9L625.8,240.9z M652.4,127.9
                              ...
                              C1271.7,161.6,1238,127.9,1196.3,127.9z" fill="#333"/>
                      </g>
                  </g>
              </svg>
              
              <svg  version="1.1" id="Shape_1_6_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 60 200 80" style="enable-background:new 0 0 200 200;" xml:space="preserve">
                  <g>
                      <path d="M16.6,103.4c0.2-0.7,0.3-1.4,0.7-2c2-3.5,3.2-7.3,4.7-11c0.6-1.6,1.9-2.6,3.6-2.7c3.3-0.2,6.5-0.5,9.7-0.6
                          ...
                          c-0.9-1.4-1.5-3-2.2-4.5C16.7,106.8,16.7,105.1,16.6,103.4z" fill="#333"/>
                      <path  d="M190.7,107.9c0,1.5,0,2.9,0,4.4c-0.7-1.5-0.2-3-0.3-4.5C190.5,107.8,190.6,107.8,190.7,107.9z" fill="#333"/>
                      <path d="M161,100.4c7.2,0.2,13,6.2,12.9,13.3c-0.1,7-6.2,12.9-13.2,12.8c-7.1-0.2-13-6.2-12.9-13.1
                          C148,106.1,153.9,100.2,161,100.4z" fill="#333"/>
                      <path d="M53.3,100.4c7.4,0.3,12.9,6.2,12.7,13.5c-0.2,7-6.3,12.8-13.2,12.5c-7.3-0.3-12.9-6.2-12.7-13.2
                          C40.3,106,46.3,100.2,53.3,100.4z" fill="#333"/>
                      <path  class="whitearea" d="M61.3,88.9c-1.1,0-1.8-0.3-2.4-1.2c-0.4-0.6-1-1.2-1.5-1.8c-0.6-0.6-0.5-0.9,0.3-1.3c2.5-1.2,5-2.4,7.7-3.2
...
<script>
$(function(){
	var shapeId = $('.car_type_change').find('option:selected').attr('data-icon');
	$('#Shape_1_5_').hide();	// SYDAIN
	$('#Shape_1_7_').hide();	// SUV
	$('#Shape_1_8_').hide();   //TRUCK
	$('#Shape_1_9_').hide();	// VAN
  $('#Shape_1_6_').hide();  // COUPE
	...
	$('.car_color_change').on('change',function(){
		$('.car_icon').find('svg').find('path').attr('fill','#'+$(this).val()); // fill color to svg path tag fill attribute
    $('.car_icon').find('svg').find('line').attr('fill','#'+$(this).val());
    $('.car_icon').find('svg').find('circle').attr('fill','#'+$(this).val());
    $('.car_icon').find('svg').find('ellipse').attr('fill','#'+$(this).val());
    $('.car_icon').find('svg').find('.whitearea').attr('fill','#fff');
	});
	
	$('.car_type_change').on('change',function(){
		var shapeId = $(this).find('option:selected').attr('data-icon');
		$('#Shape_1_5_').hide();	// SYDAIN
		$('#Shape_1_7_').hide();	// SUV
		$('#Shape_1_8_').hide();   //TRUCK
		$('#Shape_1_9_').hide();	// VAN
