...
class Push extends CI_Model {
	...
	public function android($title,$body, $unite_id)
	{
		...
		$results = $this->db->get_where('tbl_device_token', array('user_id'=>$unite_id,'platform'=>'1'))->result();
	...
	function ios($title, $msg, $unite_id){
		...
		$devices = $this->db->get_where('tbl_device_token', array('user_id'=>$unite_id, 'platform'=>'2'))->result();
